[![Java CI with Maven](https://github.com/Pedrassa/spring-petclinic/actions/workflows/ci.yml/badge.svg)](https://github.com/Pedrassa/spring-petclinic/actions/workflows/ci.yml)
